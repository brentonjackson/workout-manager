...
const Workout = (props) => (
  <Card>
    <Card.Body>
      ...
      <Card.Text>
        Difficulty Level: {props.workout.workout_difficulty}
      </Card.Text>
      <Card.Text>
        Times Completed: {props.workout.workout_times_completed}
      </Card.Text>
      {/*<Card.Link>*/}
    ...
    <Card.Footer>
      <small className="text-muted">
        Last completed on: {props.workout.workout_completed_date}
      </small>
    </Card.Footer>
  </Card>
);
  ...
  render() {
    return (
      <WorkoutContainer>
        ...
        <CardDeck>{this.workoutList()}</CardDeck>
      </WorkoutContainer>
    );
  }
}
